...
import { AutoUpdateTrigger } from './auto-update-handler';
import {
  apiCmds,
  apiName,
  ConfigUpdateType,
...
import { getSource } from 'renderer/components/desktop-capturer/desktop-capturer';
 ...
 */
local.ipcRenderer.on(ScreenShareEvents.STOPPED, (_event, id) => {
