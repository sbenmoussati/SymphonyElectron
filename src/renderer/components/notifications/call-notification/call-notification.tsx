...
> {
  ...
  public componentWillUnmount(): void {
    // window.electron.ipcRenderer.removeListener('call-notification-data', this.updateState);
  }
  ...
  private click = (id: number) => {
    window.electron.ipcRenderer.sendMessage(CallNotificationEvents.CLICKED, id);
  };
