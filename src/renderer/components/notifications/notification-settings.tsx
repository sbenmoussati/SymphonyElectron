...
import { NotificationSettingsEvents } from 'common/ipcEvent';
...
export default class NotificationSettings extends React.Component<{}, IState> {
  ...
  public componentWillUnmount(): void {
    // ipcRenderer.removeListener(NotificationSettingsEvents.DATA, this.updateState);
  }
   ...
   * @param event
   */
  public selectDisplay(event: any): void {
   ...
   * @param event
   */
  public togglePosition(event: any): void {
    this.setState({
