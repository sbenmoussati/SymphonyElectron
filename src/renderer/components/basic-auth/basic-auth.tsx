...
import { BasicAuthEvents } from '../../../common/ipcEvent';
import * as React from 'react';
import './basic-auth.less';
...
export default class BasicAuth extends React.Component<{}, IState> {
  ...
  public componentDidMount(): void {
    window.electron.ipcRenderer.on(BasicAuthEvents.DATA, this.updateState);
  }
  ...
  public componentWillUnmount(): void {
    // window.electron.ipcRenderer.removeListener('basic-auth-data', this.updateState);
  }
   ...
   */
  private close(): void {
    window.electron.ipcRenderer.sendMessage(BasicAuthEvents.CLOSED, false);
  }
